// src/pages/SalesPerformancePage.tsx
...
const SalesPerformancePage = () => {
  ...
  // Primary & Secondary Sales Data (same as before)
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="primary" className="w-full">
          ...
          <TabsContent value="secondary" className="space-y-6">
            {/* Same structure for Secondary Sales */}
            {/* ... (copy from primary, just change data source) */}
          </TabsContent>
        </Tabs>
      </div>
